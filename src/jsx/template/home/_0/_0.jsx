...
import { Container, Box, Grid, Typography, Button, Stack, alpha } from '@mui/material';
...
const template = () => {
  return (
    <>
      <Box sx={{ py: { xs: 15, md: 10}, background: `linear-gradient(180deg, ${alpha(blue[50], .5)} 0%, ${blue[50]} 100%)` }}>
        <Container>
          <Grid container spacing={6} alignItems="center">
            <Grid item xs={12} md={7}>
              <Stack spacing={2} sx={{ textAlign: { xs: 'center', md: 'left' } }}>
                <Typography variant="h1">Delivering the promise of Hybrid and Decentralized Clinical Trials (DCT)</Typography>
                <Typography variant="subtitle1">Making drug trials accessible, inclusive, faster, and cheaper with a unified platform enabling home-visit, site-visit, tele-visit, lab-visit, devices, sensors &amp; more...</Typography>
                <Box mt={2}>
