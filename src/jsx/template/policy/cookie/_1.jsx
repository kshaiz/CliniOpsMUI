        ...
        <Stack spacing={4}>
          ...
          <Box>
            <Stack spacing={1}>
              ...
              <Typography variant="body1">For the Chrome web browser, please visit this page from Google: <Link href="https://support.google.com/accounts/answer/32050" target="_blank" underline="hover">https://support.google.com/accounts/answer/32050</Link></Typography>
              <Typography variant="body1">For the Internet Explorer web browser, please visit this page from Microsoft: <Link href="https://support.microsoft.com/kb/278835" target="_blank" underline="hover">https://support.microsoft.com/kb/278835</Link></Typography>
              <Typography variant="body1">For the Firefox web browser, please visit this page from Mozilla: <Link href="https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored" target="_blank" underline="hover">https://support.mozilla.org/en-US/kb/delete-cookies-remove-info-websites-stored</Link></Typography>
          ...
          <Box>
            <Stack spacing={1}>
              ...
              <Typography variant="body1">You can learn more about cookies here: <Link href="https://www.termsfeed.com/blog/cookies/" target="_blank" underline="hover">All about cookies by TermsFeed</Link></Typography>
            </Stack>
          </Box>
          <Box>
            <Stack spacing={1}>
